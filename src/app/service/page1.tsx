      ...
      <div className="ins-tile__wrap ins-tile__animated">
        ...
        <div className="ins-tile__footer">
          <div className="ins-tile__description ins-tile__format">
            ...
            <p>
              <strong>{t('2. Bulk Purchase Discounts (ብጅምላ ዝጎድል ዋጋ)')}</strong>{t(
              '— Save big on large orders for business or events—with competitive pricing and fast shipping.'
            )}<br />{t(
            ...
            <p>
              <strong>{t('3. Suggested Design Variations (ብኣኹም ዝተቀረቡ ዲዛይንናት)')}</strong> — Explore our curated, innovative design ideas across apparel, home décor, and accessories.
              <br />{t(
          ...
          <div className="ins-tile__buttons">
            ...
            <div className="ins-button-wrap ins-tile__button ins-tile__button--secondary" data-preview-mode="false">
              ...
              >
                <div className="ins-control__button">
                  <div className="ins-control__wrap">
                    <div className="ins-control__text">{t('Contact Us')}</div>
                  </div>
                </div>
              </Link>
            </div>
